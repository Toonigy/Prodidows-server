...
class ModHandler {
	...
	initWalkSpeedMod() {
		...
		Prodigy.Container.CreatureContainer.prototype.setPath = function(e, t, i) {
			if (Util.isDefined(e)) {
				this.game.tweens.removeFrom(this, !1),
				this.game.tweens.removeFrom(this.sprites),
				Util.isDefined(i) || (i = this.game.prodigy.player.walkSpeed * this.walkSpeed);
		...
		let OGopenOther = Prodigy.Menu.SystemMenu.prototype.openOther;
		Prodigy.Menu.SystemMenu.prototype.openOther = function() {
			OGopenOther.call(this);
			this.walkSpeedBar = this.game.prodigy.create.slider(this.content, 37, 245, 525, !1, !1),
			...
			this.game.prodigy.player.walkSpeed = (this.walkSpeedBar.page + 1) / 10, this.game.prodigy.create.font(this.content, 37, 215, "Walk Speed", {
				width: 525,
				align: "center"
			})
		}
